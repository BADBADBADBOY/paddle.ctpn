...
class CTPNLoss(nn.Layer):
    ...
    def forward(self, confidence, predicted_locations, labels, gt_locations):
        ...
        if labels.shape[0]==0:
            return paddle.to_tensor(0.),paddle.to_tensor(0.),paddle.to_tensor(0.)
        ...
        ### cal location loss
        if labels.max()<1:
             return loss_cls,paddle.to_tensor(0.),paddle.to_tensor(0.)
        ...
        return loss_cls, loss_ver, loss_refine
